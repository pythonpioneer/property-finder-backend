 ...
 */
const validateSpecificValues = (messages, isOptional, values) => {
    ...
    return messages.map(name => {
        const validationChain = check(name, `Enter a valid ${name}`).isIn(values);
...
module.exports = { validateSpecificValues };